...
namespace MiniProject
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string sql1 = "insert into results values ('" + er.Text + "','" + asp.Text + "','" + ens.Text + "','" + icn.Text + "','" + java.Text + "','" + prj.Text + "')";
            try
            {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            string sql1 = "insert into grades values('" + er.Text + "','" + aspgrade.Text + "','" + ensgrade.Text + "','" + icngrade.Text + "','" + javagrade.Text + "','" + projectgrade.Text + "')";
            try
            {
                SqlCommand cmd = new SqlCommand(sql1, cn);
                cmd.ExecuteNonQuery();
